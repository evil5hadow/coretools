...
# Usage:
# ./eye_see.sh [target_ip/range]
# ./eye_see.sh 10.11.1.0/24
...
nmap -sT -p $ports -oX $nmap_out $1

# Capture screenshot with EyeWitness
python $ew_path/EyeWitness.py -x $nmap_out --all-protocols --user-agent "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.9 Safari/537.36" --no-prompt --jitter 5 --threads 2 --timeout 5 --max-retries 2
